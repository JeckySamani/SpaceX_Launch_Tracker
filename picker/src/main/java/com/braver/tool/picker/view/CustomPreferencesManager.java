...
import static com.braver.tool.picker.view.PermissionUtils.IS_PERMISSION_DIALOG_ANDROID_11;
...
public class CustomPreferencesManager {
    private static final String NOTIFICATION_PREFERENCES_NAME = "picker_preferences";
